...
export const About = () => {
  return (
    <section className="laptop:h-[100vh] ">
      <img src="https://res.cloudinary.com/dbf8xygxz/image/upload/v1739972640/morph-bg3_bw8vba.svg" alt="background for section about" className="absolute z-0  object-cover top-[95vh] left-0 h-[100vh] max-h-[100vh] animate-zoomInOut" />
