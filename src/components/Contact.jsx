...
export const Contact = () => {
  return (
    <section className="min-h-[100vh] bg-[url('https://res.cloudinary.com/dwjbiceg4/image/upload/v1745326427/d11601cfa9fc6820ba2ea9f6aea22dbc_aidsru.jpg')] bg-cover pb-40 laptop:pb-0">
