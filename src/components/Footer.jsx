...
export const Footer = () => {
  return (
    <footer className="absolute bottom-0 left-0 flex w-screen justify-between h-fit p-2 laptop:px-6 font-body text-stone-500">
      ...
      <p className="text-[10px] font-body hidden laptop:block">
        © Carlie Consulting 2025 | All Rights Reserved
      </p>
      <p className="text-[10px] font-body laptop:hidden">
        © Carlie Consulting 2025
      </p>
    </footer>
  );
};
